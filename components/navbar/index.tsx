      ...
      <div className="container mx-auto px-4 py-4">
        ...
        >
          <div className="py-4 space-y-4">
            <button
              onClick={() => scrollToSection("features")}
              className="block w-full text-left text-foreground hover:text-primary cursor-pointer transition-colors font-medium"
            >
              Features
            </button>
            <button
            ...
            <Button variant="hero" className="w-full h-8 py-1.5" onClick={handleSubmit}>
              {session?.user ? "Launch App" : "Sign In"}
            </Button>
          </div>
        </motion.div>
